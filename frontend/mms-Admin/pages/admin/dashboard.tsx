...
const tasks = [
  {
    name: "Room liberary articlewrite.",
    days: "2 days ago",
    icon: taskIconLarge
  },
  {
...
const Home = () => {
  return (
    <DashboardLayout title="Dashboard">
      <div className="dashboard__details flex items-center  justify-between ">
        <div className="bg-mmsPry3 w-[194px] h-[92px]  rounded-[7px] pl-[20px] pr-4 py-2">
        ...
        <div className="bg-green11 border px-[12px] py-[11.5px]  border-[#E6FDFE] h-[92px]  rounded-[10px] flex space-x-[28px]">
          {data.map((item, index) => (
            <div
              key={index}
              className="dashboard__info rounded-[7px]   h-[69px] bg-mmsPry10 px-[19px] py-[7px] flex items-center space-x-[29px] "
            >
      ...
      <div className="programoverview__container w-full bg-green11 border border-mmsPry10 h-[188px] my-[28px] rounded-[10px] px-[19px] py-[9px]">
        <h3 className="text-mmsBlack1 font-semibold text-lg mb-[10px]">
          Program overview
        </h3>

        <div className="programoverview__cards__container flex justify-between">
      ...
      <div className="reportoverview__container w-full bg-green11 border border-mmsPry10 h-[188px] my-[28px] rounded-[10px] px-[19px] py-[9px]">
        <h3 className="text-mmsBlack1 font-semibold text-lg mb-[10px]">
          Reports overview
        </h3>

        <div className="reportoverview__container flex justify-between">
      ...
      <div className="reportoverview__container w-full bg-green11 border border-mmsPry10 h-[341px] my-[28px] rounded-[10px] px-[19px] py-[9px]">
        <h3 className="text-mmsBlack1 font-semibold text-lg mb-[10px]">
          Tasks overview
        </h3>

        <div className="inprogress__tasks mb-[62px] flex items-center  space-x-[28px] w-full">
          <div className="tasks__indicator h-[92px] w-[120px] rounded-[10px] bg-mmsPry3 flex items-center justify-center">
            <p className="text-green11 font-semibold text-xl tracking-tighter">
              In Progress
            </p>
          </div>

          <div className="tasks__row w-full flex justify-between ">
            {tasks.map((item, index) => (
              <div
                className="task__container flex bg-mmsPry10 rounded-[10px] h-[92px] w-[283px] justify-between px-[9px] py-[17px]"
                key={index}
              >
                <div className="icon">
                  <Image src={item.icon} alt="" className="" />
                ...
                <div className="tasks__detials">
                  ...
                  <div className="task__date flex space-x-[3px] items-center ">
                    <svg
                      width="18"
                      height="18"
                      viewBox="0 0 18 18"
        ...
        <div className="completed__tasks flex items-center space-x-[28px]">
          <div className="tasks__indicator h-[92px] w-[120px] rounded-[10px] bg-mmsPry3 flex items-center justify-center">
            <p className="text-green11 font-semibold text-xl tracking-tighter">
              Completed
            </p>
